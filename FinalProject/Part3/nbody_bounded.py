...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 22 09:23:21 2020
...
if __name__=='__main__':
    ...
    p = particle(pos=pos,vel=v,size=n, N=N, soft=soft, dt=0.05, cosmology=None, bound='bounded', m = 1)
    ...
    vv = []
    aa = []
    p.plot3d_rho('nbody_bounded/0.png')
    ...
    for i in range(1,it):
        ...
        p.plot3d_rho(f'nbody_bounded/{i}.png')
    ...
    plt.savefig('energy_bounded.png')